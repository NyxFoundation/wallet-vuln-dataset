...
| [`data/mechanism_comparison.csv`](data/mechanism_comparison.csv) | — | `fig2` as a table: per mechanism, both sides' share, the difference, and Fisher/Holm p — generated by [`scripts/mechanism_comparison.py`](scripts/mechanism_comparison.py) from the same rows the figure reads |
